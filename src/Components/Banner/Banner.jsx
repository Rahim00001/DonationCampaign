...
const Banner = () => {
    ...
    return (
        <div className="banner relative text-center w-full mx-auto h-[580px] ml-7 md:m-auto">
            <div>
            ...
            <div className="overlay flex flex-col justify-center items-center w-full">
                <h2 className='text-3xl md:text-4xl lg:text-5xl xl:text-6xl mb-5 lg:mb-10 font-bold mr-5'>I Grow By Helping People In Need</h2>
                <div>
